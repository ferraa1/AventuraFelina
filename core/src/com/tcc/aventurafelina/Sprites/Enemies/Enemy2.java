...
public class Enemy2 extends Enemy{
    ...
    public Enemy2(PlayScreen screen, float x, float y) {
        ...
        frames.add(new TextureRegion(screen.getAtlas().findRegion("enemy2"), 32, 0, 32, 32));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("enemy2"), 64, 0, 32, 32));
        enemyWalk = new Animation(0.2f, frames);
        frames.clear();
        enemyStand = new TextureRegion(screen.getAtlas().findRegion("enemy2"), 0, 0, 32, 32);
        enemyDead = new TextureRegion(screen.getAtlas().findRegion("enemy2"), 96, 0, 32, 32);
